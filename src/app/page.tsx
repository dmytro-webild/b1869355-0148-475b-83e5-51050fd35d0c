...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      description="A student-led initiative organizing donation drives and assembling essential kits for individuals and families in need across Charlotte."
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/people-doing-charity-work-together_23-2148687310.jpg",
          alt: "Volunteer 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-people-with-donations_23-2149142768.jpg",
          alt: "Volunteer 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/group-different-people-volunteering-foodbank-poor-people_23-2149012208.jpg",
          alt: "Volunteer 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/african-american-activist-checks-isolated-mockup-laptop_482257-91114.jpg",
          alt: "Volunteer 5",
        },
      ]}
    />
      ...
      features={[
        {
          ...
          title: "Empowerment",
          descriptions: [
            "Supporting youth to lead positive changes in their own communities.",
          ],
        ...
        },
        {
          ...
          title: "Compassion",
          descriptions: [
            "Ensuring everyone has access to basic necessities with dignity and respect.",
          ],
